...
public class ShoppingCartServiceImpl  implements
        ShoppingCartService {

    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#delShoppingCartById(java.lang.Long)
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#changeShoppingCartById(java.lang.Long, java.lang.Long)
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#changeShoppingCartMarket(java.lang.Long, java.lang.Long)
     */
    @Override
        ...
        if(customerId!=null){
            ...
            if (null != cookies) {
              for (Cookie cookie : cookies) {
                    if(cookie!=null && "_npstore_mId".equals(cookie.getName())){
                            ...
                            for (int j = 0; j < mIds.length; j++) {
                               ...
                               if(mid[0]!=null){
                                   if(mid[0].equals(shoppingCartId.toString())){
                                       newMid+=shoppingCartId+"e"+marketingId+"e"+marketingActivityId+"e"+"1"+"-";
                                   }else{
                                       newMid+=mIds[j]+"-";
                                   }
                               }
              ...
              Cookie cookie=new Cookie("_npstore_mId",newMid);
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#searchByProduct(javax.servlet.http.HttpServletRequest, java.lang.Long[])
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#addShoppingCart(com.ningpai.site.shoppingcart.bean.ShoppingCart, javax.servlet.http.HttpServletRequest)
     */
    @Override
    @Transactional
        ...
        if(null != custId){
            ...
            if(count==0){
                ...
                if(shoppingCart.getFitId()==null){
                    ...
                    //活动优惠id
                    Long activeMarketId= marketService.queryByCreatimeMarketings( shoppingCart.getGoodsInfoId(), (long)2,goodsDetailBean.getProductVo().getGoods().getCatId(),goodsDetailBean.getBrand().getBrandId());
                    Marketing marketing =null;
                    List<Marketing> markList= marketService.selectMarketingByGoodsInfoId(shoppingCart.getGoodsInfoId(), goodsDetailBean.getBrand().getBrandId(),  goodsDetailBean.getProductVo().getGoods().getCatId());
                    //单品优惠id
                    Long marketId=0L;
                    // 单品折扣促销只能有一个
            ...
            if (null != cookies) {
                 for (Cookie cookie : cookies) {
                    if(null != cookie && "_npstore_shopcar".equals(cookie.getName())){
                        oldCar= URLDecoder.decode(cookie.getValue(),ConstantUtil.UTF);
                        if(oldCar.indexOf(","+shoppingCart.getGoodsInfoId()+"-") != -1){
                            num = oldCar.substring(oldCar.indexOf(","+shoppingCart.getGoodsInfoId()+"-"),(oldCar.indexOf(","+shoppingCart.getGoodsInfoId()+"-")+oldCar.substring(oldCar.indexOf(","+shoppingCart.getGoodsInfoId()+"-"),oldCar.length()-1).indexOf("&")));
                        ...
                        if(cookie.getValue()!=null&& !"".equals(cookie.getValue())){
                            ...
                            for (int j = 0; j < mIds.length; j++) {
                               ...
                               if(mid[0]!=null && "".equals(mIds[0])){
                                   if(!mid[0].equals(shoppingCart.getGoodsInfoId().toString())){
                                       mId=cookie.getValue();
                                   }
            ...
            //单品优惠id
            Long marketId= marketService.queryByCreatimeMarketings( shoppingCart.getGoodsInfoId(), (long)1,goodsDetailBean.getProductVo().getGoods().getCatId(),goodsDetailBean.getBrand().getBrandId());
            //活动优惠id
            Long activeMarketId= marketService.queryByCreatimeMarketings( shoppingCart.getGoodsInfoId(), (long)2,goodsDetailBean.getProductVo().getGoods().getCatId(),goodsDetailBean.getBrand().getBrandId());
           
            mId+="-"+shoppingCart.getGoodsInfoId()+"e"+marketId+"e"+activeMarketId+"e"+"0";
            cook=new Cookie("_npstore_shopcar", URLEncoder.encode(oldCar,ConstantUtil.UTF));
            cook.setMaxAge(15*24*3600);
            cook.setPath("/");
            response.addCookie(cook);
            Cookie cookie=new  Cookie("_npstore_mId", mId);
            cookie.setMaxAge(15*24*3600);
            cookie.setPath("/");
            response.addCookie(cookie);
            return 1;
    ...
    public int limtShopping(ShoppingCart shoppingCart, Long custId) {
        //进入此处标示该购物车为商品，执行商品方法
            ...
            //限购
            Marketing mk=marketService.marketingDetail(marketService.queryByCreatimeMarketings(gb.getProductVo().getGoodsInfoId(),3L,gb.getProductVo().getGoods().getCatId(),gb.getBrand().getBrandId()));
            //存在限购
            if(mk!=null){
                ...
                if(num!=null){
                    if(stock-num-shoppingCart.getGoodsNum()<=0){
                        return 0;
                    }
                }
           }
     ...
     /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#loadCookShopCar()
     */
                        ...
                        if(cookie.getValue()!=null&&!"".equals(cookie.getValue())){
                            ...
                            if (null != cars && cars.length>0) {
                                for (int i = 0; i < cars.length; i++) {
                                    ...
                                    if(car[0].length() > 6 && "110012".equals(car[0].substring(0, 6))){
                                        ...
                                        for(Cookie cook:cookies){
                                            //设置优惠
                                            if(cook!=null && "_npstore_mId".equals(cook.getName())){
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#delCookShopCar(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public int delCookShopCar(Long productId,HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        ...
        try {
                    ...
                    if(cookie!=null && "_npstore_mId".equals(cookie.getName())){
                        if(cookie.getValue()!=null&& !"".equals(cookie.getValue())){
                            ...
                            for (int j = 0; j < mIds.length; j++) {
                               ...
                               //判断是否该商品
                               if(mid[0]!=null){
                                   if(!mid[0].equals(productId.toString())){
                                       newMid+=mIds[j]+"-";
                                   }
            ...
            cook.setPath("/");
            response.addCookie(cook);
            Cookie cookie=new Cookie("_npstore_mId", URLEncoder.encode(newMid,ConstantUtil.UTF));
            cookie.setMaxAge(15*24*3600);
            cookie.setPath("/");
            response.addCookie(cookie);
            return count;
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#deleteShoppingCartByIds(javax.servlet.http.HttpServletRequest, java.lang.Long[])
     */
    @Override
    public int deleteShoppingCartByIds(HttpServletRequest request,
            Long[] shoppingCartId) {
        List<Long> list= new ArrayList<Long>();
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#loadCoodeShopping(javax.servlet.http.HttpServletRequest)
     */
    @Override
            ...
            if(list!=null&&list.size()!=0){
                for(ShopCarUtil su : list){
                    ...
                    if(su.getFitId()==null){
                        ...
                        //设置套装商品id
                        shoppingCart.setGoodsInfoId(Long.parseLong(("110012"+su.getFitId())));
                        //设置套装id
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#changeShoppingCartOrderMarket(com.ningpai.site.shoppingcart.bean.ShoppingCart)
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#selectShoppingCart(javax.servlet.http.HttpServletRequest, com.ningpai.site.shoppingcart.bean.ShoppingCartWareUtil, com.ningpai.util.PageBean)
     */
    public PageBean selectShoppingCart(HttpServletRequest request,
            ShoppingCartWareUtil cartWareUtil, PageBean pb,HttpServletResponse response) {
        Long customerId = (Long) request.getSession().getAttribute("customerId");
        //如果已经登录
        if(customerId!=null){
                 ...
                 for(int i=0;i<shoplist.size();i++){
                        try{
                            try{
                                ...
                                //限购
                                Marketing marketing=marketService.marketingDetail(marketService.queryByCreatimeMarketings(goodsDetailBean.getProductVo().getGoodsInfoId(),3L,goodsDetailBean.getProductVo().getGoods().getCatId(),goodsDetailBean.getBrand().getBrandId()));
                                //存在限购
                                if(marketing!=null){
                                    Long stock=marketing.getLimitBuyMarketing().getLimitCount();
                                    //最近是否购买过该商品
                                    Long num=orderser.selectGoodsInfoCount(((ShoppingCart)shoplist.get(i)).getGoodsDetailBean().getProductVo().getGoodsInfoId(),customerId ,marketing.getMarketingBegin());
                                    if(num!=null){
                                        stock=stock-num;
                                        if(stock<0){
                                            stock=0L;
                        ...
                        if(((ShoppingCart)shoplist.get(i)).getFitId()==null){
                            ((ShoppingCart)shoplist.get(i)).setMarketingList(marketService.selectMarketingByGoodsInfoId(((ShoppingCart)shoplist.get(i)).getGoodsDetailBean().getProductVo().getGoodsInfoId(), ((ShoppingCart)shoplist.get(i)).getGoodsDetailBean().getBrand().getBrandId(),((ShoppingCart)shoplist.get(i)).getGoodsDetailBean().getProductVo().getGoods().getCatId()));
                        }
            ...
            try {
                ...
                if(list!=null&&list.size()!=0){
                    ...
                    pb.setPageSize(5);
                     ...
                     if(shoplist!=null&&shoplist.size()!=0){
                         for(int i=0;i<shoplist.size();i++){
                             Object sessionStatus=request.getSession().getAttribute("_npstore_shopstatus");
                             boolean bool=true;
                             ...
                             request.getSession().setAttribute("_npstore_shopstatus", sessionStatus);
                             GoodsDetailBean goodsDetailBean=goodsProductService.queryDetailBeanByProductId(((ShoppingCart)shoplist.get(i)).getGoodsInfoId(),cartWareUtil.getDistrictId());
                             if(goodsDetailBean==null){
                                 continue;
                             }
     ...
     * 获取商品库存
     */
    public void getGoodsStock(ShoppingCartWareUtil cartWareUtil,
            List<Object> shoplist, int i) {
         //判断是否存在
          //查询库存
         ProductWare productWare=productWareService.queryProductWareByProductIdAndDistinctId(((ShoppingCart)shoplist.get(i)).getGoodsDetailBean().getProductVo().getGoodsInfoId() , cartWareUtil.getDistrictId());
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#selectPNameByParam(javax.servlet.http.HttpServletRequest)
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#delGoodsGroupByS(java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public int delGoodsGroupByS(Long shoppingCartId, Long goodsInfoId,
            Long fitId,HttpServletRequest request,HttpServletResponse response) {
        Long customerId = (Long) request.getSession().getAttribute("customerId");
        Long gId=null;
        if(customerId==null){
            gId=Long.parseLong(("110012"+fitId));
        }  
        //先查询到分组下的所有商品
                //所有的优惠分组
    ...
    /* 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#changeShopStatus(java.lang.Long, java.lang.String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    @Override
    public String changeShopStatus(Long shoppingId, String status,
            HttpServletRequest request, HttpServletResponse response) {
        //获取当前选中状态的session
        Object obj=request.getSession().getAttribute("_npstore_shopstatus");
        String newStr="";
        //判断session是否有值
        if(obj!=null){
            //获取所有的购物车状态
            ...
            for (String  str: strs) {
                ...
                if(shopStatus[1].equals(shoppingId.toString())){
                    newStr=status+"e"+shoppingId+"-"+newStr;
                }else{
                    newStr+=str+"-";
                }
            }
        }
        request.getSession().setAttribute("_npstore_shopstatus", newStr);
        newStr=null;
        obj=null;
        return status;
    }
    ...
    /*
     * 
     * @see com.ningpai.site.shoppingcart.service.ShoppingCartService#changeShopStatusByParam(java.lang.Long[], java.lang.String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    @Override
    public String changeShopStatusByParam(Long[] shoppingId, String status,
            HttpServletRequest request, HttpServletResponse response) {
        String newStr="";
    ...
    public List<Coupon> getUsedCouponlist(HttpServletRequest request, Long[] box){
        ...
        if (CollectionUtils.isNotEmpty(shoplist)) {
            ...
            for (int i = 0; i < shoplist.size(); i++) {
                    ...
                    GoodsDetailBean detailBean = goodsProductService.queryDetailBeanByProductId(((ShoppingCart) shoplist.get(i)).getGoodsInfoId(), ((ShoppingCart) shoplist.get(i)).getDistinctId());
                    //查询商品详细
                ...
                for(Coupon cou:couponList){
                    ...
                    for(CouponRange ran:ranList){
                        ...
                        if(cou.getCouponId().equals(ran.getCouponId())){
                            //按分类
                            if(ran.getCouponRangeType().equals("0")){

                                if(ran.getCouponRangeFkId().equals(shoplist.get(i).getGoodsDetailBean().getProductVo().getGoods().getCatId())){
                                    //商家的总金额
                            ...
                            //按品牌
                            if(ran.getCouponRangeType().equals("1")){
                                if(ran.getCouponRangeFkId().equals(shoplist.get(i).getGoodsDetailBean().getBrand().getBrandId())){
                                    //商家的总金额
                                    sumprice=sumprice.add(goodsprice.multiply(BigDecimal.valueOf(shoplist.get(i).getGoodsNum())));
                            ...
                            //按货品
                            if(ran.getCouponRangeType().equals("2")){
                                if(ran.getCouponRangeFkId().equals(shoplist.get(i).getGoodsDetailBean().getProductVo().getGoodsInfoId())){
                                    //商家的总金额
                                    sumprice=sumprice.add(goodsprice.multiply(BigDecimal.valueOf(shoplist.get(i).getGoodsNum())));
            ...
            if(CollectionUtils.isNotEmpty(groupmarketList)){
                    ...
                    if (markMap.containsKey(shop.getMarketingActivityId())) {
                        ...
                        if (CollectionUtils.isNotEmpty(mark.getFullbuyReduceMarketings())) {
                            for (FullbuyReduceMarketing fpm : mark.getFullbuyReduceMarketings()) {
                                ...
                                //达到满减条件
                                if (fpm.getFullPrice().compareTo(totalprice) == -1) {
                        ...
                        if (CollectionUtils.isNotEmpty(mark.getFullbuyDiscountMarketings())) {
                            ...
                            for (FullbuyDiscountMarketing fdm : mark.getFullbuyDiscountMarketings()) {
                                if (fdm.getFullPrice().compareTo(totalprice) == -1) {
                ...
                for (int k = 0; k < cartList.size(); k++) {
                    ...
                    if (cartList.get(k).getMarketing()!=null&&cartList.get(k).getMarketing().getPriceOffMarketing() != null) {
                        // sumOldPrice = sumOldPrice.subtract(cartList.get(k).getMarketing().getPriceOffMarketing().getOffValue().multiply(BigDecimal.valueOf(cartList.get(k).getGoodsNum())));
...
if(customerAddress!=null&&customerAddress.getDistrict()!=null){
        ...
        if (shoplist != null && !shoplist.isEmpty()) {
            for (int i = 0; i < shoplist.size(); i++) {
                ...
                if (shoplist.get(i).getFitId() == null) {
                    ...
                    shoplist.get(i).setGoodsDetailBean(detailBean);
                    //查询商品参加的促销信息
                    shoplist.get(i).setMarketingList(marketService.selectMarketingByGoodsInfoId(shoplist.get(i).getGoodsInfoId(), shoplist.get(i).getGoodsDetailBean().getBrand().getBrandId(), shoplist.get(i).getGoodsDetailBean().getProductVo().getGoods().getCatId()));
                    shoplist.get(i).setMarketing(marketService.marketingDetail(shoplist.get(i).getMarketingActivityId(), shoplist.get(i).getGoodsInfoId()));
                    ParamIds p = new ParamIds();
                    p.setCouponRangeFkId(shoplist.get(i).getGoodsDetailBean().getProductVo().getGoodsInfoId());
                    p.setCouponRangeType("2");
                    ...
                    if(shoplist.get(i).getThirdId()==0&&distinctId!=null){
                        // 根据地区id重新查询不同仓库的价格
                        ProductWare productWare = productWareService.queryProductWareByProductIdAndDistinctId(shoplist.get(i).getGoodsDetailBean().getProductVo().getGoodsInfoId(), distinctId);
                        if (productWare != null) {
                            // 设置商品库存
                    ...
                    for (int j = 0; j < goodsGroupReleProductVos.size(); j++) {
                        ...
                        GoodsDetailBean goodsDetailBean = goodsProductService.queryDetailBeanByProductId(goodsGroupReleProductVos.get(j).getProductDetail().getGoodsInfoId(), distinctId);
    ...
    @Override
    public Map<String, Object> subOrder(HttpServletRequest request, Long[] box,
                 ...
                 List<Object> thirdIds = new ArrayList<Object>();
                    ...
                    if(shoplist!=null&&shoplist.size()!=0){
                        for(ShoppingCart sc:shoplist){
                            ...
                            if (sc.getFitId() == null) {
                                //判断是否包邮
                              Long  baoyou= marketService.queryByCreatimeMarketings(sc.getGoodsInfoId(), 6L, sc.getGoodsDetailBean().getProductVo().getGoods().getCatId(), sc.getGoodsDetailBean().getBrand().getBrandId());
                                if(baoyou!=0){
                                    sc.setIsBaoyou("1");
                                }else{
                                    sc.setIsBaoyou("0");
                 ...
                 if(shoplist!=null&&shoplist.size()!=0){
                     for(int i=0;i<shoplist.size();i++){
                         ...
                         for (int j = 0; j < thirdIds.size(); j++) {
                            if(shoplist.get(i).getGoodsDetailBean().getProductVo().getThirdId() == thirdIds.get(j)){
    ...
    /*
     * 
     * @see com.ningpai.m.shoppingcart.service.ShoppingCartService#selectLastId(com.ningpai.m.shoppingcart.bean.ShoppingCart, javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpServletRequest)
     */
    @Override
    ...
    /*
     * 
     * @see com.ningpai.m.shoppingcart.service.ShoppingCartService#forPurchasing(com.ningpai.m.goods.bean.GoodsDetailBean)
     */
    @Override
                ...
                for (int m = 0; m < shopThirdList.size(); m++) {
                    ...
                    for (int k = 0; k < baoyou.size(); k++) {
                        ...
                        for (ShoppingCart scra : shop) {
                            if (scra.getThirdId() == baoyou.get(k).getThirdId()) {

                                //参与包邮但没有达到条件包邮
                                if (scra.getMarketgoodsPrice().compareTo(baoyou.get(k).getMarketing().getShippingMoney()) == -1) {
