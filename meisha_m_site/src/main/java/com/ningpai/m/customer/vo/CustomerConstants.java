...
public final class CustomerConstants {
    ...
    public static final String REDIRECTLOGINTOINDEX = "redirect:/login.html?url=/customer/index.html";
    ...
    public static final String REDIRECTTOINDEX = "redirect:/customer/index.html";
