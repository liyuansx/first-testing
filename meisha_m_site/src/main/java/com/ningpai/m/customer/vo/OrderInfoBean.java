...
public class OrderInfoBean {
    ...
    public Long getGoodsId() {
        goodsId = getGoods().size() == 0 ? null : getGoods().get(0).getGoodsId();
        return goodsId;
    }
    ...
    public String getGoodsName() {
        goodsName = getGoods().size() == 0 ? "" : getGoods().get(0).getGoodsName();
        return goodsName;
    }
    ...
    public String getGoodsImg() {
        goodsImg = getGoods().size() == 0 ? "" : getGoods().get(0).getGoodsImg();
        return goodsImg;
    }
