...
public class LoginController {
    ...
    public ModelAndView loginOut(HttpServletRequest request, String url) throws UnsupportedEncodingException {
        ...
        setResultMap(request, resultMap, url);
    ...
    @ResponseBody
    public Object checkLogin(HttpServletRequest request, HttpServletResponse response, String username, String password, String url, String type) throws UnsupportedEncodingException {
