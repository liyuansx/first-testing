...
public class MobMainSiteController {
    ...
    public ModelAndView thirdStoreIndex(HttpServletRequest request,Long storeId) throws Exception {
        ...
        if ("1".equals(msb.getTemp2())) {
           ...
           int flag= showNewHomePage(request,storeId);
            mav.setViewName("/main/store" + STOREID + "/store_main");
            //标记是否配置模板
    ...
    private void showNewHomePage(Long homePageId, HttpServletRequest request) throws Exception {
        ...
        // MobHomePage homePage = this.mobHomePageService.selectHomePageByMerchantId(STOREID);
        ...
        htmlFileName = htmlFileName.replace("/main", "/main/store" + STOREID);
        // 判断是否有html
    ...
    private void checkFileExistsAndMkdirs(HttpServletRequest request,String url) throws Exception {
        ...
        File storeFilePath = new File(rootPath + "view/main/store" + STOREID);

        File storeFile = new File(rootPath + "view/main/store" + STOREID+"/"+url+".ftl");
        ...
        if (!storeFile.exists()) {
            try {
                ...
                String newPath = rootPath + "view/main/store" + STOREID + "/"+url+".ftl";
