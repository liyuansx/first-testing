		    		...
		    		$.ajax({
		    	         ...
		    	         success: function(data) {
		    	        	 if (data > 0){
		    	        		 eFlag = false;
		    	        		 $("#error-info").removeClass("hidden");
		    	        		 $("#error-info").find(".error-tip").html("手机号已注册,请更换手机号");
		    	         ...
		    	         error: function(){
		    	        	 ...
		    	        	 $("#error-info").removeClass("hidden");
		    	        	 $("#error-info").find(".error-tip").html("网络异常，请稍后再试！");
		    	     	 }
		    		 });
		    		if(eFlag && !mFlag){
		    			mFlag = true;
...
//	    						$("#mc_btn").attr('class','btn btn-default');
		    					...
		    					$("#mc_btn").attr('class','btn_yz');
		    		    	}
		    		    });
		    			
		    			function countDown(){
		    				var time = $("#mc_btn").attr('data-t');
		    				$("#mc_btn").html((time - 1)+"s后重新获取");
