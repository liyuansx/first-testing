...
<div id="meishaContent" class="ks" style="display: none">
    <h3 class="pop-tit">meisha产品演示</h3>
    <div class="ks-desc">请点击演示版观看<br/>
        如有疑问，也可直接拨打我司025-68586888-2电话进行免费咨询。
    </div>
    <a href="http://meisha.qianmi.com" class="btn-reg" target="_balnk">前台演示版</a>
    <a href="http://meisha.qianmi.com/boss/" class="btn-reg" target="_balnk">后台演示版</a>
    </div>
