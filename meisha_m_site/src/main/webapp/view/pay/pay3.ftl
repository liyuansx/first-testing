    ...
    <script Language="javascript">
                                ...
                                "paySign" : getSign() //微信签名
                                      ...
                                      if(res.err_msg == "get_brand_wcpay_request:ok" ) {
                                       var orderId=$("#orderId").val();
                                      	alert("支付成功！");
                                      	location.href="${basePath}/order/orderpaysuccess.html?orderId="+orderId;
                                      }else{
                                      
	                                    var orderId=$("#orderId").val();
                                      	location.href="${basePath}/otherpay-"+orderId+".html";
                                      }
        ...
        <form name="form1" target="_blank" style="display:none" >
            <table border="1">
                ...
                <TR><th>订单编号</th><th><INPUT value="${orderPayCode}" name="tradeno" id="5"></th>
