...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="good_simple_info">
      ...
      <p class="main_price">￥${map.detailBean.productVo.goodsInfoPreferPrice?string("0.00")}</p>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered" width="100%">
               <#list map.detailBean.expandPrams as expandParam>
               		<tr>
		                <td width="30%" align="right">${expandParam.expandParamVo.expandparamName}</td>
		                <td>${expandParam.expangparamValue.expandparamValueName}</td>
		            </tr>
               </#list>
            </table>
          </div>
